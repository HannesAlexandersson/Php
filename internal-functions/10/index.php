...
foreach($episodes as $episode){
    echo "The episode ".$episode['title']." was released ".diffInYears($episode['released_at'])." years ago";?><br><?php
}
...
/* 
echo date( "Y" ,$episodes[0]['released_at']); //vi måste omvandla strtotime formatet till ett format vi kan använda, date funktionen tar som första parameter vilket format vi vill ha i detta fallet 'Y' för fyrsiffrigt årtal
